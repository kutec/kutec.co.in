          ...
          <div className="col-md-9 col-sm-12 order-md-0 order-1">
            ...
            <p className="mt-4">
              ...
              <FontAwesomeIcon
                ...
                icon={["fas", "bicycle"]}
              />{" "}
              lover by passion and{" "}
              <FontAwesomeIcon className="text-danger" icon={["fas", "code"]} />{" "}
              by profession. Sed eu orci nec tellus pretium facilisis.
              Suspendisse ac scelerisque sem. Aliquam pulvinar lorem sit amet
              nunc suscipit dapibus. Vivamus pellentesque iaculis lacus aliquam
              fringilla. Donec eu diam dui. Interdum et malesuada fames ac ante
              ipsum primis in faucibus. Etiam ut rhoncus massa.
            </p>
            {/* </Col> */}
          </div>
